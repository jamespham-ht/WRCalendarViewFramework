...
SWIFT_MODULE_NAMESPACE_PUSH("WRCalendarViewFramework")
...
SWIFT_CLASS("_TtC23WRCalendarViewFramework10WRWeekView")
@interface WRWeekView : UIView
...
@interface WRWeekView (SWIFT_EXTENSION(WRCalendarViewFramework)) <UICollectionViewDataSource, UICollectionViewDelegate>
